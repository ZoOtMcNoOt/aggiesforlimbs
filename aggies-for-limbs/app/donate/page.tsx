        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <Button asChild variant="outline">
                  <Link href="/general-donation-form.pdf" download>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sponsor our upcoming Carnival event on April 26th</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-gray-600">
                This Spring, we are hosting our annual Aggies for Limbs Carnival event on April 26th. Donations of $100
                or more received by November 1st will have their company logo or family name featured on the event
                shirt.
              </p>
              <div className="flex justify-between items-center">
                <Button asChild variant="outline">
                  <Link href="/event-sponsorship-form.pdf" download>
                    <Download className="mr-2 h-4 w-4" /> Download Form
                  </Link>
                </Button>
                <Button asChild>
